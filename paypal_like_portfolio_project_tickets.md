...
Dependencies are ticket IDs. A ticket should not start until all its
...
- **Weight:** 3\
- **Dependencies:** ---\
- **Goal:** Establish a consistent project structure and quality
    gates.
...
- **Weight:** 2\
- **Dependencies:** T-0001\
- **Goal:** Standardize configuration for local/dev/prod.
- **Implementation Notes (OO):**
...
- **Weight:** 3\
- **Dependencies:** T-0001\
- **Goal:** Ensure every request can be traced and errors are
    consistent.
- **Implementation Notes (OO):**
...
- **Priority:** P0\
- **Weight:** 3\
- **Dependencies:** T-0101, T-0501\
- **Goal:** Verify primary email to reduce fraud and enable
    notifications.
- **OO Objects:**
...
- **Weight:** 3\
- **Dependencies:** T-0101\
- **Goal:** Protect endpoints based on roles and ownership.
- **OO Objects:**
  - Value Object: `Role`
...
- **Weight:** 3\
- **Dependencies:** T-0001\
- **Goal:** Prevent floating point and currency mistakes.
- **OO Objects:**
...
- **Priority:** P0\
- **Weight:** 8\
- **Dependencies:** T-0201, T-0101\
- **Goal:** Create an append-only double-entry ledger.
- **OO Objects:**
...
- **Weight:** 5\
- **Dependencies:** T-0202\
- **Goal:** Each user gets a wallet ledger account (and supporting
    internal accounts).
- **OO Objects:**
...
- **Priority:** P0\
- **Weight:** 4\
- **Dependencies:** T-0202, T-0203\
- **Goal:** Provide wallet balance and transaction history views.
- **OO Objects:**
...
- **Weight:** 5\
- **Dependencies:** T-0202\
- **Goal:** Model payments as a state machine with safe transitions.
- **OO Objects:**
  - Entity: `Payment`
...
- **Priority:** P0\
- **Weight:** 5\
- **Dependencies:** T-0003, T-0301\
- **Goal:** Ensure retries don't double-charge/double-write.
- **OO Objects:**
...
- **Priority:** P0\
- **Weight:** 6\
- **Dependencies:** T-0202, T-0204, T-0301, T-0302\
- **Goal:** Send money from one user wallet to another with ledger
    correctness.
- **OO Objects:**
...
- **Weight:** 5\
- **Dependencies:** T-0303\
- **Goal:** Allow a user to request money and the other to pay it.
- **OO Objects:**
  - Entity: `MoneyRequest`
...
- **Priority:** P1\
- **Weight:** 5\
- **Dependencies:** T-0303, T-0102\
- **Goal:** Send to an email that doesn't exist yet; recipient can
    claim later.
- **OO Objects:**
...
- **Priority:** P1\
- **Weight:** 5\
- **Dependencies:** T-0103, T-0203\
- **Goal:** Allow "business" users to act as merchants.
- **OO Objects:**
  - Entity: `Merchant`
...
- **Priority:** P1\
- **Weight:** 5\
- **Dependencies:** T-0401, T-0302\
- **Goal:** Create checkout orders.
- **OO Objects:**
  - Entity: `Order`
...
- **Priority:** P1\
- **Weight:** 6\
- **Dependencies:** T-0402, T-0301, T-0202, T-0302\
- **Goal:** Mimic PayPal's approve→capture flow.
- **OO Objects:**
...
- **Weight:** 3\
- **Dependencies:** T-0403\
- **Goal:** Basic UI endpoints for success/cancel and receipt display.
- **Acceptance Criteria:**
...
- **Weight:** 4\
- **Dependencies:** T-0003\
- **Goal:** Provide a notification port to use across flows.
- **OO Objects:**
...
- **Priority:** P1\
- **Weight:** 4\
- **Dependencies:** T-0201, T-0202\
- **Goal:** Compute and apply platform fees.
- **OO Objects:**
  - Value Object: `Fee`
...
- **Priority:** P2\
- **Weight:** 6\
- **Dependencies:** T-0202, T-0303, T-0502\
- **Goal:** Introduce pending/held balances for risk or delayed
    settlement.
- **OO Objects:**
  - Service: `HoldService`
  - Job: `HoldReleaseJob`
...
- **Priority:** P1\
- **Weight:** 6\
- **Dependencies:** T-0202, T-0403, T-0301, T-0302\
- **Goal:** Reverse payments safely via ledger.
- **OO Objects:**
  - Entity: `Refund`
...
- **Priority:** P2\
- **Weight:** 6\
- **Dependencies:** T-0403, T-0501\
- **Goal:** Allow buyers to open disputes on merchant payments.
- **OO Objects:**
  - Entity: `DisputeCase`
...
- **Priority:** P1\
- **Weight:** 6\
- **Dependencies:** T-0202, T-0303\
- **Goal:** Emit reliable events for side effects (notifications,
...
- **Priority:** P2\
- **Weight:** 6\
- **Dependencies:** T-0701, T-0401\
- **Goal:** Allow merchants to receive signed event notifications.
- **OO Objects:**
...
- **Priority:** P2\
- **Weight:** 4\
- **Dependencies:** T-0101, T-0303\
- **Goal:** Prevent basic abuse and demonstrate security maturity.
- **OO Objects:**
...
- **Priority:** P2\
- **Weight:** 5\
- **Dependencies:** T-0503, T-0701\
- **Goal:** Centralize risk decisions and keep them auditable.
- **OO Objects:**
  - Service: `RiskEngine`
...
- **Priority:** P2\
- **Weight:** 5\
- **Dependencies:** T-0103, T-0204, T-0303, T-0403\
- **Goal:** Provide an admin dashboard-like API for inspection.
- **OO Objects:**
  - Query Services + DTOs
- **Acceptance Criteria:**
...
- **Weight:** 3\
- **Dependencies:** T-0901\
- **Goal:** Provide simple reporting export capability.
- **Acceptance Criteria:**
...
- **Priority:** P3\
- **Weight:** 8\
- **Dependencies:** T-0201, T-0202, T-0203, T-0403\
- **Goal:** Support multiple currencies per wallet and transaction
    constraints.
- **Acceptance Criteria:**
...
- **Priority:** P3\
- **Weight:** 6\
- **Dependencies:** T-0701, T-0204\
- **Goal:** Faster balance queries via projections.
- **Acceptance Criteria:**
...
- **Priority:** P3\
- **Weight:** 8\
- **Dependencies:** T-0701, T-0301\
- **Goal:** Replace parts of persistence with event streams for
    learning.
- **Acceptance Criteria:**
