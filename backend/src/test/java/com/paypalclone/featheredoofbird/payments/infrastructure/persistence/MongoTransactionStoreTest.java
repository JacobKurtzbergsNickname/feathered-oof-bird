...
class MongoTransactionStoreTest {
    ...
    void saveMapsTransactionToDocument() {
        ...
        when(mongoTransactionRepository.save(
                        new TransactionDocumentMapper().toDocument(transaction)))
        ...
        ArgumentCaptor<TransactionDocument> captor =
                ArgumentCaptor.forClass(TransactionDocument.class);
